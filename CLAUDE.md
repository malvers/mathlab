...
22. **„Sprecht Euch immer ab, aber push ist freigegeben" (Doc 2026-09-20).** Das löst die Einzel-Freigabe vom 2026-07-05/06 ab: Push auf `main` ist ab jetzt **dauerhaft frei** — kein Warten mehr auf „push" vor jedem Stand, **bis Doc ausdrücklich zurücknimmt** („kein push" / „stopp push").
    - **„Absprechen" ist der Preis dafür und keine Floskel:** vor dem Push sagen, **was** rausgeht, und danach die Commit-Hashes nennen. Nichts klammheimlich hinterherschieben. Bei allem, was Doc gerade noch bewertet (Optik-Iterationen, halbfertige Experimente), **erst fragen** — „freigegeben" heißt nicht „ungefragt", es heißt nur: kein Freigabe-Ritual mehr für fertige, getestete Arbeit.
