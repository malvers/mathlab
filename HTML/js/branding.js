...
/** When a sidebar host exists but only a floating nav is present, it often blocks the later integrated bar. */
...
const CyberBranding = {
    ...
    injectLabVideo() {
        ...
        a.target = '_blank';
        a.rel = 'noopener';
        a.title = 'Video-Demo ansehen';
        a.setAttribute('aria-label', 'Video-Demo ansehen');
        a.innerHTML = '<svg viewBox="0 0 28.57 20" aria-hidden="true"><path d="M27.973 3.123A3.578 3.578 0 0 0 25.447.597C23.22 0 14.285 0 14.285 0S5.35 0 3.123.597A3.578 3.578 0 0 0 .597 3.123C0 5.35 0 10 0 10s0 4.65.597 6.877a3.578 3.578 0 0 0 2.526 2.526C5.35 20 14.285 20 14.285 20s8.935 0 11.162-.597a3.578 3.578 0 0 0 2.526-2.526C28.57 14.65 28.57 10 28.57 10s-.002-4.65-.597-6.877z" fill="#FF0000"/><path d="M11.425 14.285 18.848 10l-7.423-4.285v8.57z" fill="#fff"/></svg>';
        // Plays right here in a lightbox instead of tearing the lab away into
        // a new tab. Middle-click / Cmd-click still open YouTube (href stays).
        a.addEventListener('click', (e) => {
            if (e.metaKey || e.ctrlKey || e.shiftKey || e.button !== 0) return;
            e.preventDefault();
            e.stopPropagation();
            this.openLabVideo(url);
        });
    ...
    injectNavigation() {
        ...
        /* Lucide “bug” icon (antennae/legs), stroke via CSS 1.5 */
        bugBtn.innerHTML = `
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
