...
(function () {
    ...
    t.index = {
            ...
            header: {
                ...
                author: "GOOD VIBES von Dr. Michael R. Alvers"
            },
            view: {
                back_title: "Zurück",
                title: "LABOR-ANSICHT"
            ...
            ,
                ...
                "tour-wuerfelspiel": { title: "Tour: Fünf von neun", description: "Live-Tour durch das Würfelspiel-Lab: Solita führt mit Stimme, Cursor und Untertiteln vom ersten Wurf über Baumdiagramm, Pfad- und Summenregel bis zu Efrons nicht-transitiven Würfeln — das echte Lab läuft dabei live im Browser. 24 Szenen, etwa 10 Minuten, jederzeit anhalten und selbst ausprobieren." },
                "tour-mission-control": { title: "Tour: Die ganze Klasse im Blick", description: "Live-Tour durch Mission Control: einen Online-Test live begleiten — vom Zettel mit QR-Code über Status, Verlassen und den roten Knopf bis zur Abgabe und Auswertung. Solita erklärt mit Stimme und Untertiteln; gespielt wird mit einer Vorführ-Klasse im Browser, ganz ohne echte Daten. Etwa 3 Minuten." },
                "tour-maya": { title: "Tour: Punkt, Strich, Muschel", description: "Live-Tour durch das Maya-Rechenbrett, gesprochen von Doc Alvers (KI-Stimmklon), mit Cursor und Untertiteln: die zwanzig Ziffern aus Punkt, Strich und Muschel, Ziffern legen, der Übertrag von 59 auf 60, eine Zahl eintippen, Würfelaufgaben, Kalender oder reine Zwanzig und die Schreibweise hochkant. Das echte Lab läuft dabei live im Browser. 12 Szenen, etwa 3 Minuten, jederzeit anhalten und selbst ausprobieren." },
                "tour-trigonometrie": { title: "Tour: Vom Dreieck zur Welle", description: "Live-Tour durch das Trigonometrie-Lab: Solita führt mit Stimme, Cursor und Untertiteln durch alle elf Kapitel — vom rechtwinkligen Dreieck über Einheitskreis und Bogenmaß, die Sinuskurve, die aus dem Kreis abrollt, Gleichungen, Parameter mit Rätsel und die Tageslänge in Dresden bis zu Tangens, Sinussatz und Ableitung. Das echte Lab läuft dabei live im Browser. 12 Szenen, etwa 4½ Minuten, jederzeit anhalten und selbst ausprobieren." },
