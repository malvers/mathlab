...
(function () {
    ...
    t.index = {
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "A graphing and CAS calculator as a device in the browser: exact arithmetic with fractions, roots and π, solving equations, plotting functions, rotating 3D graphs, statistics and probability — all through keys and menus like on the real calculator. Under ⚙ ▸ Demo, Solita walks you through the first topics with voice and mouse. Password access; your device remembers it." },
                ...
                "tour-wuerfelspiel": { title: "Tour: Five out of Nine", description: "Live tour of the Dice Game lab: Solita guides you with voice, cursor and subtitles from the first roll through the tree diagram, the product and sum rules to Efron's non-transitive dice — while the real lab runs live in your browser. 24 scenes, about 10 minutes, pause anytime and try it yourself. Spoken in German." },
                "tour-mission-control": { title: "Tour: The Whole Class at a Glance", description: "Live tour of Mission Control: accompany an online test live — from the slip with the QR code through status, leaving and the red button to submission and evaluation. Solita explains with voice and subtitles; it plays with a demo class in the browser, without any real data. About 3 minutes. Spoken in German." },
                "tour-maya": { title: "Tour: Dot, Bar, Shell", description: "Live tour of the Maya counting board, narrated by Doc Alvers (AI voice clone) with cursor and subtitles: the twenty digits made of dot, bar and shell, laying digits, the carry from 59 to 60, typing a number, dice tasks, calendar count versus pure base 20 and the upright notation — while the real lab runs live in your browser. 12 scenes, about 3 minutes, pause anytime and try it yourself. Spoken in German." },
                "tour-trigonometrie": { title: "Tour: From Triangle to Wave", description: "Live tour of the Trigonometry lab: Solita guides you with voice, cursor and subtitles through all eleven chapters — from the right triangle via the unit circle and radians, the sine curve rolling out of the circle, equations, parameters with a puzzle and the day length in Dresden to the tangent, the law of sines and the derivative — while the real lab runs live in your browser. 12 scenes, about 4½ minutes, pause anytime and try it yourself. Spoken in German." },
                ...
                "wuerfelspiel": { title: "The Dice Game", description: "Two self-labelled dice and one question: how likely is Lena to win? The tour follows the classroom deck station by station — reading dice nets, merging equal numbers into one branch, drawing the tree stage by stage, the path rule and the sum rule, the five typical mistakes and a twin task with solution; Solita explains in her own voice. In the lab you label the dice yourself, and tree, table, mistakes and result recalculate at once. Plus a simulation in which the relative frequency closes in on the probability, and Efron's non-transitive dice that beat each other in a circle." },
                "marionwalter": { title: "Marion Walter's Theorem", description: "Trisect every side of an arbitrary triangle and join each division point to the opposite corner. The six cevians enclose a hexagon, and its area is always exactly one tenth of the triangle — however lopsided you pull the shape. The lab does not claim it, it measures: the hexagon falls out of six half-plane cuts, the area comes from the shoelace formula, and the gap to the exact value is printed next to it. Divide the sides at k/n instead and 2(n−2k)²/((2n−k)(n+k)) gives the ratio — only the trisection yields the clean tenth. On demand the lab colours all 19 pieces." },
                "kreisteilung": { title: "Dividing the Circle", description: "n points on a circle, every chord drawn — into how many regions does the disc fall apart? 1, 2, 4, 8, 16 … and then 31, not 32. The lab does not count with a formula; it walks the real graph of arcs and chord pieces. That is why it also shows the degenerate case: the regular hexagon yields only 30 regions, because three diagonals meet at the centre. Drag any point along the circle and watch the count jump from 30 to 31." },
