...
(function () {
    ...
    t.index = {
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "Una calculadora gráfica y CAS como dispositivo en el navegador: cálculo exacto con fracciones, raíces y π, resolución de ecuaciones, gráficas de funciones, gráficos 3D que se pueden girar, estadística y probabilidad — todo con teclas y menús como en la calculadora real. En ⚙ ▸ Demo, Solita guía por los primeros temas con voz y ratón. Acceso con contraseña; el dispositivo la recuerda." },
                ...
                "tour-wuerfelspiel": { title: "Recorrido: Cinco de nueve", description: "Recorrido en vivo por el laboratorio del juego de dados: Solita guía con voz, cursor y subtítulos desde el primer lanzamiento, pasando por el diagrama de árbol y las reglas del producto y de la suma, hasta los dados no transitivos de Efron, mientras el laboratorio real funciona en el navegador. 24 escenas, unos 10 minutos; se puede pausar y probar en cualquier momento. Hablado en alemán." },
                "tour-mission-control": { title: "Recorrido: Toda la clase a la vista", description: "Recorrido en vivo por Mission Control: acompañar un examen en línea en directo, desde la hoja con el código QR, el estado, las salidas y el botón rojo hasta la entrega y la evaluación. Solita lo explica con voz y subtítulos; se usa una clase de demostración en el navegador, sin datos reales. Unos 3 minutos. Hablado en alemán." },
                "tour-maya": { title: "Recorrido: Punto, raya, concha", description: "Recorrido en vivo por el tablero de cálculo maya, narrado por Doc Alvers (clon de voz con IA) con cursor y subtítulos: las veinte cifras hechas de punto, raya y concha, colocar cifras, el acarreo de 59 a 60, teclear un número, tareas con dados, la cuenta del calendario frente a la base 20 pura y la escritura vertical, mientras el laboratorio real funciona en el navegador. 12 escenas, unos 3 minutos; se puede pausar y probar en cualquier momento. Hablado en alemán." },
                "tour-trigonometrie": { title: "Recorrido: Del triángulo a la onda", description: "Recorrido en vivo por el laboratorio de trigonometría: Solita guía con voz, cursor y subtítulos por los once capítulos, desde el triángulo rectángulo, pasando por la circunferencia unidad y el radián, la curva del seno que se desenrolla del círculo, ecuaciones, parámetros con un acertijo y la duración del día en Dresde, hasta la tangente, el teorema del seno y la derivada, mientras el laboratorio real funciona en el navegador. 12 escenas, unos 4 minutos y medio; se puede pausar y probar en cualquier momento. Hablado en alemán." },
                ...
                "wuerfelspiel": { title: "El juego de dados", description: "Dos dados rotulados a mano y una pregunta: ¿qué probabilidad tiene Lena de ganar? El recorrido sigue la presentación de clase estación por estación — leer las redes de los dados, agrupar números iguales en una rama, dibujar el árbol etapa por etapa, la regla del camino y la regla de la suma, los cinco errores típicos y una tarea gemela con solución; Solita lo explica con su voz. En el laboratorio uno mismo rotula los dados, y árbol, tabla, errores y resultado se recalculan al instante. Además, una simulación en la que la frecuencia relativa se acerca a la probabilidad, y los dados no transitivos de Efron, que se ganan en círculo." },
                "marionwalter": { title: "Teorema de Marion Walter", description: "Divide cada lado de un triángulo cualquiera en tres partes y une cada punto de división con el vértice opuesto. Las seis cevianas encierran un hexágono cuya área es siempre exactamente una décima parte del triángulo, por muy torcido que lo estires. El laboratorio no lo afirma, lo mide: el hexágono surge del corte de seis semiplanos, el área sale de la fórmula del área de Gauss y la desviación respecto al valor exacto aparece al lado. Si divides los lados en k/n, la razón es 2(n−2k)²/((2n−k)(n+k)) — solo la trisección da la décima parte limpia. Si quieres, el laboratorio colorea las 19 regiones." },
