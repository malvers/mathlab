...
(function () {
    ...
    t.index = {
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "Une calculatrice graphique et CAS sous forme d'appareil dans le navigateur : calcul exact avec fractions, racines et π, résolution d'équations, tracé de fonctions, graphes 3D à faire pivoter, statistiques et probabilités — le tout par touches et menus comme sur la vraie calculatrice. Sous ⚙ ▸ Demo, Solita guide à travers les premiers thèmes avec voix et souris. Accès par mot de passe ; l'appareil s'en souvient." },
                ...
                "tour-wuerfelspiel": { title: "Visite : Cinq sur neuf", description: "Visite guidée en direct du labo du jeu de dés : Solita guide avec la voix, le curseur et des sous-titres, du premier lancer à l'arbre de probabilités, aux règles du produit et de la somme, jusqu'aux dés non transitifs d'Efron — pendant que le vrai labo tourne dans le navigateur. 24 scènes, environ 10 minutes ; pause et essais possibles à tout moment. Commentaire en allemand." },
                "tour-mission-control": { title: "Visite : Toute la classe en un coup d'œil", description: "Visite guidée en direct de Mission Control : accompagner un test en ligne en temps réel — de la fiche avec le code QR au statut, aux sorties et au bouton rouge, jusqu'à la remise et à l'évaluation. Solita explique avec la voix et des sous-titres ; on joue avec une classe de démonstration dans le navigateur, sans aucune donnée réelle. Environ 3 minutes. Commentaire en allemand." },
                "tour-maya": { title: "Visite : Point, barre, coquillage", description: "Visite guidée en direct de l'abaque maya, commentée par Doc Alvers (clone vocal par IA) avec curseur et sous-titres : les vingt chiffres faits de points, de barres et d'un coquillage, poser des chiffres, la retenue de 59 à 60, taper un nombre, des exercices aux dés, le compte du calendrier face à la base 20 pure et l'écriture verticale — pendant que le vrai labo tourne dans le navigateur. 12 scènes, environ 3 minutes ; pause et essais possibles à tout moment. Commentaire en allemand." },
                "tour-trigonometrie": { title: "Visite : Du triangle à l'onde", description: "Visite guidée en direct du labo de trigonométrie : Solita guide avec la voix, le curseur et des sous-titres à travers les onze chapitres — du triangle rectangle au cercle trigonométrique et au radian, de la sinusoïde qui se déroule depuis le cercle aux équations, aux paramètres avec une énigme et à la durée du jour à Dresde, jusqu'à la tangente, la loi des sinus et la dérivée — pendant que le vrai labo tourne dans le navigateur. 12 scènes, environ 4 minutes et demie ; pause et essais possibles à tout moment. Commentaire en allemand." },
                ...
                "wuerfelspiel": { title: "Le jeu de dés", description: "Deux dés numérotés à la main et une question : quelle est la probabilité que Lena gagne ? Le parcours suit le diaporama du cours station par station — lire les patrons des dés, regrouper les nombres égaux en une branche, dessiner l’arbre étape par étape, la règle du chemin et la règle de la somme, les cinq erreurs typiques et un exercice jumeau corrigé ; Solita explique avec sa voix. Dans le labo, on numérote soi-même les dés, et l’arbre, le tableau, les erreurs et le résultat se recalculent aussitôt. En plus, une simulation où la fréquence relative se rapproche de la probabilité, et les dés non transitifs d’Efron qui se battent en cercle." },
                "marionwalter": { title: "Théorème de Marion Walter", description: "Partagez chaque côté d'un triangle quelconque en trois et reliez chaque point de division au sommet opposé. Les six céviennes enferment un hexagone dont l'aire vaut toujours exactement un dixième de celle du triangle, aussi tordu soit-il. Le labo ne l'affirme pas, il le mesure : l'hexagone naît de l'intersection de six demi-plans, l'aire vient de la formule du lacet, et l'écart avec la valeur exacte s'affiche à côté. Si l'on partage les côtés en k/n, le rapport vaut 2(n−2k)²/((2n−k)(n+k)) — seule la trisection donne le dixième bien rond. Au besoin, le labo colorie les 19 régions." },
