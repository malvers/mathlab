...
(function () {
    ...
    t.index = {
            ...
            ui: {
                ...
                search_no_terms: "nessun risultato",
            ...
            header: {
                ...
                author: "GOOD VIBES di Dr. Michael R. Alvers"
            },
            view: {
                back_title: "Indietro",
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "Una calcolatrice grafica e CAS come dispositivo nel browser: calcolo esatto con frazioni, radici e π, risoluzione di equazioni, grafici di funzioni, grafici 3D da ruotare, statistica e probabilità — tutto con tasti e menu come sulla calcolatrice vera. In ⚙ ▸ Demo, Solita guida attraverso i primi argomenti con voce e mouse. Accesso con password; il dispositivo la ricorda." },
                ...
                "shell": { title: "Shell", description: "Come nasce il disegno di una conchiglia? Sei capitoli costruiscono il meccanismo un pezzo alla volta: l'immagine è un registro — una cellula si accende e scrive una V — due onde si annullano e tagliano la punta di una tenda — il substrato consumato spiega perché. In alto vive il bordo dell'apertura, sotto cresce la conchiglia. Con pulsante passo-passo." },
                ...
                "tour-wuerfelspiel": { title: "Tour: Cinque su nove", description: "Tour dal vivo nel laboratorio del gioco dei dadi: Solita guida con voce, cursore e sottotitoli dal primo lancio al diagramma ad albero, alle regole del prodotto e della somma, fino ai dadi non transitivi di Efron — mentre il vero laboratorio gira nel browser. 24 scene, circa 10 minuti; si può fermare e provare in ogni momento. Parlato in tedesco." },
                "tour-mission-control": { title: "Tour: Tutta la classe sott'occhio", description: "Tour dal vivo di Mission Control: seguire in diretta una verifica online — dal foglietto con il codice QR allo stato, alle uscite e al pulsante rosso, fino alla consegna e alla valutazione. Solita spiega con voce e sottotitoli; si usa una classe dimostrativa nel browser, senza dati reali. Circa 3 minuti. Parlato in tedesco." },
                "tour-maya": { title: "Tour: Punto, barra, conchiglia", description: "Tour dal vivo nell'abaco maya, narrato da Doc Alvers (clone vocale IA) con cursore e sottotitoli: le venti cifre fatte di punti, barre e conchiglia, posare le cifre, il riporto da 59 a 60, digitare un numero, esercizi con i dadi, il conteggio del calendario contro la base 20 pura e la scrittura verticale — mentre il vero laboratorio gira nel browser. 12 scene, circa 3 minuti; si può fermare e provare in ogni momento. Parlato in tedesco." },
                "tour-trigonometrie": { title: "Tour: Dal triangolo all'onda", description: "Tour dal vivo nel laboratorio di trigonometria: Solita guida con voce, cursore e sottotitoli attraverso tutti gli undici capitoli — dal triangolo rettangolo alla circonferenza goniometrica e al radiante, dalla sinusoide che si srotola dal cerchio alle equazioni, ai parametri con un indovinello e alla durata del giorno a Dresda, fino alla tangente, al teorema dei seni e alla derivata — mentre il vero laboratorio gira nel browser. 12 scene, circa 4 minuti e mezzo; si può fermare e provare in ogni momento. Parlato in tedesco." },
                ...
                "jacquard": { title: "Jacquard", description: "Un telaio del 1805, in 3D — la prima macchina che produce un'immagine seguendo un piano scritto. Una scheda perforata comanda ogni filo di ordito separatamente: dove c'è un foro l'ago passa, l'uncino resta fermo e il coltello solleva il filo; dove c'è cartone il filo resta in basso e la trama blu lo copre. Scheda dopo scheda l'immagine esce dalla macchina. Motivo e macchina sono due cose diverse: lo stesso cerchio viene più rotondo con più fili, e dove il disegno è più fine del tessuto il telaio tesse un motivo che nell'originale non esiste." },
                "koerper": { title: "Solidi", description: "Solidi platonici, archimedei e di Catalan, prismi, antiprismi, piramidi e forme rotonde — ruotabili in 3D, con superficie, volume, raggi della sfera circoscritta, tangente agli spigoli e inscritta, angoli diedri e formule dal vivo in funzione dello spigolo. Ogni solido si apre nel suo sviluppo con un cursore; i solidi di Catalan nascono come duali degli archimedei per polarità rispetto alla sfera tangente agli spigoli." },
                "wuerfelspiel": { title: "Il gioco dei dadi", description: "Due dadi numerati a mano e una domanda: con quale probabilità vince Lena? Il percorso guidato segue le slide della lezione stazione per stazione — leggere gli sviluppi dei dadi, raggruppare i numeri uguali in un ramo, disegnare l’albero stadio per stadio, la regola del percorso e la regola della somma, i cinque errori tipici e un esercizio gemello con soluzione; Solita spiega con la sua voce. Nel laboratorio i dadi si numerano da sé, e albero, tabella, errori e risultato si ricalcolano subito. In più una simulazione in cui la frequenza relativa si avvicina alla probabilità, e i dadi non transitivi di Efron che si battono in cerchio." },
                "marionwalter": { title: "Teorema di Marion Walter", description: "Dividi in tre parti ogni lato di un triangolo qualsiasi e congiungi ogni punto di divisione con il vertice opposto. Le sei ceviane racchiudono un esagono la cui area è sempre esattamente un decimo di quella del triangolo, per quanto storto lo si tiri. Il laboratorio non lo afferma, lo misura: l'esagono nasce dal taglio di sei semipiani, l'area viene dalla formula dell'area di Gauss e lo scarto dal valore esatto compare accanto. Dividendo i lati in k/n il rapporto è 2(n−2k)²/((2n−k)(n+k)) — solo la trisezione dà il decimo pulito. A richiesta il laboratorio colora tutte le 19 regioni." },
                "kreisteilung": { title: "Divisione del cerchio", description: "n punti su una circonferenza, tutte le corde tracciate: in quante regioni si divide il disco? 1, 2, 4, 8, 16 … e poi 31, non 32. Il laboratorio non conta con una formula, ma percorre davvero il grafo di archi e pezzi di corda. Per questo mostra anche il caso degenere: l’esagono regolare dà solo 30 regioni, perché tre diagonali si incontrano nel centro. Trascina un punto lungo la circonferenza e il conteggio salta da 30 a 31." },
                "brahmagupta": { title: "Teorema di Brahmagupta", description: "Un quadrilatero ciclico le cui diagonali sono perpendicolari — e due affermazioni che lo riguardano, entrambe di Brahmagupta (VII secolo, India). Il teorema: dal punto d’incontro P delle diagonali si abbassa la perpendicolare a un lato e la si prolunga oltre P; essa incontra il lato opposto esattamente nel suo punto medio — perché P forma con i due estremi un triangolo rettangolo e il piede della perpendicolare ne è il circocentro. La formula: K = √((s−a)(s−b)(s−c)(s−d)) dà l’area, ma solo finché tutti e quattro i vertici stanno sulla circonferenza. Se li si toglie, K risulta troppo grande — la formula di Erone per i quadrilateri, con una condizione." }
            }
    };
})();
