...
(function () {
    ...
    t.index = {
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "Een grafische en CAS-rekenmachine als apparaat in de browser: exact rekenen met breuken, wortels en π, vergelijkingen oplossen, functies plotten, 3D-grafieken draaien, statistiek en kansrekening — alles via toetsen en menu's zoals op de echte rekenmachine. Onder ⚙ ▸ Demo leidt Solita je met stem en muis door de eerste onderwerpen. Toegang met wachtwoord; het apparaat onthoudt het." },
                ...
                "shell": { title: "Shell", description: "Hoe ontstaat het patroon op een zeeschelp? Zes hoofdstukken bouwen het mechanisme stuk voor stuk op: het beeld is een logboek — één cel ontsteekt en schrijft een V — twee golven doven elkaar en snijden de punt van een tent — het opgebruikte substraat verklaart waarom. Bovenaan leeft de mondrand, daaronder groeit de schelp. Met stap-voor-stap knop." },
                ...
                "tour-wuerfelspiel": { title: "Rondleiding: Vijf van de negen", description: "Live rondleiding door het dobbelspel-lab: Solita leidt je met stem, cursor en ondertitels van de eerste worp via het boomdiagram, de product- en somregel naar de niet-transitieve dobbelstenen van Efron — terwijl het echte lab live in de browser draait. 24 scènes, ongeveer 10 minuten; op elk moment pauzeren en zelf proberen. Gesproken in het Duits." },
                "tour-mission-control": { title: "Rondleiding: De hele klas in beeld", description: "Live rondleiding door Mission Control: een online toets live begeleiden — van het briefje met de QR-code via status, weggaan en de rode knop tot inleveren en beoordelen. Solita legt uit met stem en ondertitels; er wordt gespeeld met een demoklas in de browser, zonder echte gegevens. Ongeveer 3 minuten. Gesproken in het Duits." },
                "tour-maya": { title: "Rondleiding: Punt, streep, schelp", description: "Live rondleiding door het Maya-rekenbord, ingesproken door Doc Alvers (AI-stemkloon) met cursor en ondertitels: de twintig cijfers van punt, streep en schelp, cijfers leggen, de overdracht van 59 naar 60, een getal intypen, dobbelopgaven, de kalendertelling tegenover zuiver twintigtallig en de staande schrijfwijze — terwijl het echte lab live in de browser draait. 12 scènes, ongeveer 3 minuten; op elk moment pauzeren en zelf proberen. Gesproken in het Duits." },
                "tour-trigonometrie": { title: "Rondleiding: Van driehoek tot golf", description: "Live rondleiding door het goniometrie-lab: Solita leidt je met stem, cursor en ondertitels door alle elf hoofdstukken — van de rechthoekige driehoek via de eenheidscirkel en de radiaal, de sinuskromme die uit de cirkel afrolt, vergelijkingen, parameters met een puzzel en de daglengte in Dresden tot de tangens, de sinusregel en de afgeleide — terwijl het echte lab live in de browser draait. 12 scènes, ongeveer 4,5 minuut; op elk moment pauzeren en zelf proberen. Gesproken in het Duits." },
                ...
                "jacquard": { title: "Jacquard", description: "Een weefgetouw uit 1805, in 3D — de eerste machine die een beeld maakt naar een opgeschreven plan. Eén ponskaart stuurt elke kettingdraad afzonderlijk: waar een gat zit glijdt de naald erdoor, de haak blijft staan en het mes tilt de draad op; waar karton zit blijft hij beneden en de blauwe inslag dekt hem af. Kaart na kaart groeit het beeld uit de machine. Motief en machine zijn twee verschillende dingen: dezelfde cirkel wordt ronder met meer kettingdraden, en waar de tekening fijner is dan het weefsel weeft het getouw een patroon dat in het origineel helemaal niet voorkomt." },
                ...
                "wuerfelspiel": { title: "Het dobbelspel", description: "Twee zelf beschreven dobbelstenen en één vraag: hoe groot is de kans dat Lena wint? De rondleiding volgt de lespresentatie station voor station — uitslagen lezen, gelijke getallen samenvoegen tot één tak, de boom trap voor trap tekenen, de padregel en de somregel, de vijf typische fouten en een tweelingopgave met oplossing; Solita legt het uit met haar stem. In het lab beschrijf je de dobbelstenen zelf, en boom, tabel, fouten en resultaat rekenen meteen mee. Plus een simulatie waarin de relatieve frequentie naar de kans kruipt, en de niet-transitieve dobbelstenen van Efron die elkaar in een kring verslaan." },
                "marionwalter": { title: "Stelling van Marion Walter", description: "Verdeel elke zijde van een willekeurige driehoek in drie en verbind elk deelpunt met de overstaande hoek. De zes cevianen sluiten een zeshoek in, en die heeft altijd precies een tiende van de oppervlakte van de driehoek — hoe scheef je hem ook trekt. Het lab beweert dat niet, het meet: de zeshoek ontstaat uit het snijden van zes halfvlakken, de oppervlakte komt uit de schoenveterformule en de afwijking van de exacte waarde staat ernaast. Verdeel je de zijden in k/n, dan geeft 2(n−2k)²/((2n−k)(n+k)) de verhouding — alleen de driedeling levert het gladde tiende. Desgewenst kleurt het lab alle 19 deelvlakken." },
                "kreisteilung": { title: "Cirkelverdeling", description: "n punten op een cirkel, alle koorden getekend — in hoeveel gebieden valt de schijf uiteen? 1, 2, 4, 8, 16 … en dan 31, niet 32. Het lab telt niet met een formule, maar loopt de echte graaf van bogen en koordstukken af. Daardoor toont het ook het ontaarde geval: de regelmatige zeshoek levert maar 30 gebieden op, omdat drie diagonalen elkaar in het midden treffen. Sleep een punt over de cirkel en de telling springt van 30 naar 31." },
                "brahmagupta": { title: "Stelling van Brahmagupta", description: "Een koordenvierhoek waarvan de diagonalen loodrecht op elkaar staan — en twee uitspraken daarover, allebei van Brahmagupta (7e eeuw, India). De stelling: laat vanuit het snijpunt P van de diagonalen de loodlijn op een zijde neer en trek hem door voorbij P, dan treft hij de overstaande zijde precies in het midden — want P vormt met de twee eindpunten een rechthoekige driehoek en de voet van de loodlijn is het middelpunt van diens omgeschreven cirkel. De formule: K = √((s−a)(s−b)(s−c)(s−d)) geeft de oppervlakte, maar alleen zolang alle vier de hoekpunten op de cirkel liggen. Haal je ze eraf, dan wordt K te groot — Heron voor vierhoeken, met een voorwaarde." }
            }
    };
})();
