...
(function () {
    ...
    t.index = {
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "Uma calculadora gráfica e CAS como dispositivo no navegador: cálculo exato com frações, raízes e π, resolução de equações, gráficos de funções, gráficos 3D para rodar, estatística e probabilidade — tudo por teclas e menus como na calculadora real. Em ⚙ ▸ Demo, a Solita guia pelos primeiros temas com voz e rato. Acesso com palavra-passe; o dispositivo lembra-se dela." },
                ...
                "tour-wuerfelspiel": { title: "Visita: Cinco em nove", description: "Visita guiada ao vivo pelo laboratório do jogo dos dados: a Solita guia com voz, cursor e legendas desde o primeiro lançamento, passando pelo diagrama de árvore e pelas regras do produto e da soma, até aos dados não transitivos de Efron — enquanto o laboratório real corre no navegador. 24 cenas, cerca de 10 minutos; pode parar e experimentar a qualquer momento. Falado em alemão." },
                "tour-mission-control": { title: "Visita: A turma toda à vista", description: "Visita guiada ao vivo pelo Mission Control: acompanhar um teste online em direto — da folha com o código QR ao estado, às saídas e ao botão vermelho, até à entrega e à avaliação. A Solita explica com voz e legendas; usa-se uma turma de demonstração no navegador, sem dados reais. Cerca de 3 minutos. Falado em alemão." },
                "tour-maya": { title: "Visita: Ponto, barra, concha", description: "Visita guiada ao vivo pelo ábaco maia, narrada por Doc Alvers (clone de voz por IA) com cursor e legendas: os vinte algarismos feitos de ponto, barra e concha, colocar algarismos, o transporte de 59 para 60, escrever um número, tarefas com dados, a contagem do calendário face à base 20 pura e a escrita vertical — enquanto o laboratório real corre no navegador. 12 cenas, cerca de 3 minutos; pode parar e experimentar a qualquer momento. Falado em alemão." },
                "tour-trigonometrie": { title: "Visita: Do triângulo à onda", description: "Visita guiada ao vivo pelo laboratório de trigonometria: a Solita guia com voz, cursor e legendas pelos onze capítulos — do triângulo retângulo ao círculo trigonométrico e ao radiano, da curva do seno que se desenrola do círculo às equações, aos parâmetros com um enigma e à duração do dia em Dresden, até à tangente, à lei dos senos e à derivada — enquanto o laboratório real corre no navegador. 12 cenas, cerca de 4 minutos e meio; pode parar e experimentar a qualquer momento. Falado em alemão." },
                ...
                "wuerfelspiel": { title: "O jogo dos dados", description: "Dois dados numerados à mão e uma pergunta: qual é a probabilidade de a Lena ganhar? A visita guiada segue os diapositivos da aula estação a estação — ler as planificações, agrupar números iguais num só ramo, desenhar a árvore etapa a etapa, a regra do caminho e a regra da soma, os cinco erros típicos e uma tarefa gémea com solução; a Solita explica com a sua voz. No laboratório numeram-se os dados, e árvore, tabela, erros e resultado recalculam logo. Além disso, uma simulação em que a frequência relativa se aproxima da probabilidade, e os dados não transitivos de Efron, que se vencem em círculo." },
                "marionwalter": { title: "Teorema de Marion Walter", description: "Divida cada lado de um triângulo qualquer em três partes e ligue cada ponto de divisão ao vértice oposto. As seis cevianas encerram um hexágono cuja área é sempre exatamente um décimo da área do triângulo, por mais torto que ele fique. O laboratório não afirma isso, ele mede: o hexágono resulta do corte de seis semiplanos, a área vem da fórmula do cadarço e o desvio em relação ao valor exato aparece ao lado. Dividindo os lados em k/n, a razão é 2(n−2k)²/((2n−k)(n+k)) — só a trissecção dá o décimo redondo. Se quiser, o laboratório colore as 19 regiões." },
