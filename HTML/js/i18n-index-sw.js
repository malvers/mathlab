...
(function () {
    ...
    t.index = {
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "Kikokotoo cha grafu na CAS kama kifaa kwenye kivinjari: hesabu kamili kwa sehemu, mizizi na π, kutatua milinganyo, kuchora fungu, kuzungusha grafu za 3D, takwimu na uwezekano — yote kwa vitufe na menyu kama kwenye kikokotoo halisi. Chini ya ⚙ ▸ Demo, Solita anakuongoza kwenye mada za kwanza kwa sauti na kipanya. Ufikiaji kwa nenosiri; kifaa kinalikumbuka." },
                ...
                "tour-wuerfelspiel": { title: "Ziara: Tano kati ya tisa", description: "Ziara ya moja kwa moja katika maabara ya mchezo wa kete: Solita anaongoza kwa sauti, kielekezi na manukuu kuanzia mrusho wa kwanza, mchoro wa mti, kanuni ya kuzidisha na ya kujumlisha hadi kete za Efron zisizo na mpangilio wa ushindi — huku maabara halisi ikifanya kazi kwenye kivinjari. Matukio 24, takriban dakika 10; simamisha wakati wowote ujaribu mwenyewe. Inazungumzwa kwa Kijerumani." },
                "tour-mission-control": { title: "Ziara: Darasa zima mbele ya macho", description: "Ziara ya moja kwa moja ya Mission Control: kufuatilia mtihani wa mtandaoni moja kwa moja — kuanzia karatasi yenye msimbo wa QR, hali, kuondoka na kitufe chekundu hadi kuwasilisha na tathmini. Solita anaeleza kwa sauti na manukuu; hutumiwa darasa la maonyesho kwenye kivinjari, bila data halisi. Takriban dakika 3. Inazungumzwa kwa Kijerumani." },
                "tour-maya": { title: "Ziara: Nukta, mstari, kombe", description: "Ziara ya moja kwa moja katika ubao wa kuhesabu wa Maya, inayosimuliwa na Doc Alvers (sauti iliyoigwa kwa AI) kwa kielekezi na manukuu: tarakimu ishirini za nukta, mstari na kombe, kupanga tarakimu, kubeba kutoka 59 hadi 60, kuandika namba, mazoezi ya kete, hesabu ya kalenda dhidi ya msingi wa 20 halisi na uandishi wa wima — huku maabara halisi ikifanya kazi kwenye kivinjari. Matukio 12, takriban dakika 3; simamisha wakati wowote ujaribu mwenyewe. Inazungumzwa kwa Kijerumani." },
                "tour-trigonometrie": { title: "Ziara: Kutoka pembetatu hadi wimbi", description: "Ziara ya moja kwa moja katika maabara ya trigonometria: Solita anaongoza kwa sauti, kielekezi na manukuu kupitia sura zote kumi na moja — kuanzia pembetatu mraba, duara la kitengo na radiani, mkunjo wa sine unaojitokeza kutoka kwenye duara, milinganyo, vigezo pamoja na fumbo na urefu wa mchana huko Dresden hadi tanjenti, kanuni ya sine na kinyambuo — huku maabara halisi ikifanya kazi kwenye kivinjari. Matukio 12, takriban dakika 4 na nusu; simamisha wakati wowote ujaribu mwenyewe. Inazungumzwa kwa Kijerumani." },
                ...
                "wuerfelspiel": { title: "Mchezo wa Kete", description: "Kete mbili zilizoandikwa namba kwa mkono na swali moja: uwezekano wa Lena kushinda ni upi? Ziara inafuata slaidi za darasani kituo kwa kituo — kusoma vielelezo vya kete, kuunganisha namba sawa kuwa tawi moja, kuchora mti hatua kwa hatua, kanuni ya njia na kanuni ya jumla, makosa matano ya kawaida na zoezi pacha lenye jibu; Solita anaeleza kwa sauti yake. Kwenye maabara unaandika namba za kete mwenyewe, na mti, jedwali, makosa na matokeo yanahesabiwa upya mara moja. Pia uigaji ambamo marudio linganishi yanakaribia uwezekano, na kete zisizo za mpito za Efron zinazoshindana kwa mzunguko." },
                "marionwalter": { title: "Nadharia ya Marion Walter", description: "Gawa kila upande wa pembetatu yoyote katika sehemu tatu, kisha unganisha kila kigawanyo na kona iliyo mkabala. Cevian sita hufunga pembesita, na eneo lake ni sehemu moja ya kumi ya eneo la pembetatu kila wakati — hata ukiivuta ipotoke kiasi gani. Maabara haisemi tu, inapima: pembesita hupatikana kwa kukata nusu-tambarare sita, eneo hutoka kwa fomula ya kamba ya kiatu, na tofauti na thamani kamili huonyeshwa kando. Ukigawa pande kwa k/n, uwiano ni 2(n−2k)²/((2n−k)(n+k)) — ni ugawaji wa tatu tu unaotoa moja ya kumi safi. Ukitaka, maabara hupaka rangi sehemu zote 19." },
                "kreisteilung": { title: "Ugawaji wa duara", description: "Nukta n kwenye duara, nyuzi zote zimechorwa — bamba hugawanyika katika sehemu ngapi? 1, 2, 4, 8, 16 … kisha 31, si 32. Maabara haihesabu kwa fomula, bali hupitia grafu halisi ya matao na vipande vya nyuzi. Ndiyo maana huonyesha pia hali ya kipekee: pembesita ya kawaida hutoa sehemu 30 tu, kwa sababu mishazari mitatu hukutana katikati. Buruta nukta yoyote kuzunguka duara na hesabu huruka kutoka 30 hadi 31." },
