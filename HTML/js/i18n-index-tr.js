...
(function () {
    ...
    t.index = {
            ...
            ,
                ...
                "docpad": { title: "DocPad", description: "Tarayıcıda bir cihaz olarak grafik ve CAS hesap makinesi: kesirler, kökler ve π ile tam hesaplama, denklem çözme, fonksiyon çizme, döndürülebilen 3B grafikler, istatistik ve olasılık — hepsi gerçek hesap makinesindeki gibi tuşlar ve menülerle. ⚙ ▸ Demo altında Solita, ses ve fareyle ilk konularda yol gösterir. Şifreyle erişim; cihaz şifreyi hatırlar." },
                ...
                "tour-wuerfelspiel": { title: "Tur: Dokuzda beş", description: "Zar Oyunu laboratuvarında canlı tur: Solita ses, imleç ve altyazılarla ilk atıştan ağaç diyagramına, çarpım ve toplam kuralına, oradan Efron’un geçişsiz zarlarına kadar yol gösterir — bu sırada gerçek laboratuvar tarayıcıda canlı çalışır. 24 sahne, yaklaşık 10 dakika; istediğin an durdurup kendin deneyebilirsin. Anlatım Almancadır." },
                "tour-mission-control": { title: "Tur: Bütün sınıf göz önünde", description: "Mission Control’de canlı tur: çevrimiçi bir sınavı canlı izlemek — QR kodlu kâğıttan durum, ayrılma ve kırmızı düğmeye, oradan teslim ve değerlendirmeye kadar. Solita ses ve altyazılarla anlatır; tarayıcıda gerçek veri olmadan bir gösteri sınıfıyla oynanır. Yaklaşık 3 dakika. Anlatım Almancadır." },
                "tour-maya": { title: "Tur: Nokta, çizgi, deniz kabuğu", description: "Maya hesap tahtasında canlı tur, Doc Alvers’ın sesiyle (yapay zekâ ses klonu), imleç ve altyazılarla: nokta, çizgi ve deniz kabuğundan yirmi rakam, rakam yerleştirme, 59’dan 60’a elde, sayı yazma, zar görevleri, takvim sayımı ile saf 20 tabanı ve dikey yazım — bu sırada gerçek laboratuvar tarayıcıda canlı çalışır. 12 sahne, yaklaşık 3 dakika; istediğin an durdurup kendin deneyebilirsin. Anlatım Almancadır." },
                "tour-trigonometrie": { title: "Tur: Üçgenden dalgaya", description: "Trigonometri laboratuvarında canlı tur: Solita ses, imleç ve altyazılarla on bir bölümün hepsinde yol gösterir — dik üçgenden birim çembere ve radyana, çemberden açılan sinüs eğrisinden denklemlere, bir bilmeceli parametrelere ve Dresden’deki gün uzunluğuna, oradan tanjanta, sinüs teoremine ve türeve kadar — bu sırada gerçek laboratuvar tarayıcıda canlı çalışır. 12 sahne, yaklaşık 4,5 dakika; istediğin an durdurup kendin deneyebilirsin. Anlatım Almancadır." },
                ...
                "jacquard": { title: "Jacquard", description: "1805'ten kalma bir dokuma tezgâhı, 3B olarak — yazılı bir plana göre resim üreten ilk makine. Delikli bir kart her çözgü ipliğini tek tek yönetir: delik olan yerde iğne geçer, kanca yerinde kalır ve bıçak ipliği kaldırır; karton olan yerde iplik aşağıda kalır ve mavi atkı onu örter. Kart kart resim makineden çıkar. Desen ile makine iki ayrı şeydir: aynı daire daha çok iplikle daha yuvarlak çıkar, çizim kumaştan daha ince olduğunda ise tezgâh, aslında hiç bulunmayan bir deseni dokur." },
                ...
                "wuerfelspiel": { title: "Zar Oyunu", description: "Elle numaralanmış iki zar ve tek bir soru: Lena’nın kazanma olasılığı nedir? Tur, ders sunumunu istasyon istasyon izler — zar açınımlarını okumak, aynı sayıları tek dalda birleştirmek, ağacı aşama aşama çizmek, yol kuralı ve toplama kuralı, beş tipik hata ve çözümlü bir ikiz görev; Solita kendi sesiyle anlatır. Laboratuvarda zarları kendin numaralandırırsın; ağaç, tablo, hatalar ve sonuç hemen yeniden hesaplanır. Ayrıca göreli sıklığın olasılığa yaklaştığı bir simülasyon ve birbirini döngü halinde yenen Efron’un geçişli olmayan zarları." },
                "marionwalter": { title: "Marion Walter Teoremi", description: "Herhangi bir üçgenin her kenarını üçe böl ve her bölüm noktasını karşı köşeyle birleştir. Altı çevyan bir altıgeni çevreler ve bu altıgenin alanı, üçgeni ne kadar çarpık çekersen çek, her zaman tam olarak üçgen alanının onda biridir. Laboratuvar bunu iddia etmez, ölçer: altıgen altı yarı düzlemin kesişiminden doğar, alan ayakkabı bağı formülünden gelir ve kesin değerden sapma hemen yanında yazar. Kenarları k/n'de bölersen oran 2(n−2k)²/((2n−k)(n+k)) olur — pürüzsüz onda biri yalnızca üçe bölme verir. İstenirse laboratuvar 19 parçanın tümünü boyar." },
                "kreisteilung": { title: "Çemberin bölünmesi", description: "Bir çember üzerinde n nokta ve çizilen bütün kirişler — daire kaç bölgeye ayrılır? 1, 2, 4, 8, 16 … ve sonra 32 değil, 31. Laboratuvar bir formülle saymaz; yayların ve kiriş parçalarının oluşturduğu gerçek çizgeyi dolaşır. Bu yüzden bozunmuş durumu da gösterir: düzgün altıgen yalnızca 30 bölge verir, çünkü üç köşegen merkezde kesişir. Bir noktayı çember üzerinde sürükleyin, sayı 30’dan 31’e sıçrasın." },
                "brahmagupta": { title: "Brahmagupta Teoremi", description: "Köşegenleri birbirine dik olan bir kirişler dörtgeni — ve ona ilişkin iki önerme; ikisi de Brahmagupta’dan (7. yüzyıl, Hindistan). Teorem: köşegenlerin kesişim noktası P’den bir kenara dikme indirilip P’nin ötesine uzatılırsa, karşı kenarı tam ortasında keser — çünkü P, iki uç noktayla bir dik üçgen oluşturur ve dikmenin ayağı bu üçgenin çevrel çemberinin merkezidir. Formül: K = √((s−a)(s−b)(s−c)(s−d)) alanı verir, ama yalnızca dört köşe de çember üzerindeyken. Köşeler çemberden ayrılırsa K fazla büyük çıkar — dörtgenler için Heron, bir koşulla." }
            }
    };
})();
