...
| [plan-brotkrumen.md](HTML/tracker/plan-brotkrumen.md) | Brotkrumen-Spur / Wegpunkte-Pfad | 📐 Konzept/Plan |
...
| [bug-live-broadcast-funktioniert-nicht.md](HTML/tracker/bug-live-broadcast-funktioniert-nicht.md) | Live-Broadcast geht gerade nicht — Realtime-spezifisch (Auth/Config/Pause) | 🐞 Bug |
| [plan-contact-ai-im-tracker.md](HTML/tracker/plan-contact-ai-im-tracker.md) | „Contact AI" in der App: Chat via Claude API + Agent der Repo editiert & pusht | 📐 Konzept/Plan |
...
| [agent-name-solita.md](HTML/tracker/agent-name-solita.md) | Agent-Name & Weckwort „Solita" — Begründung, Tagline, Voice-Erkennbarkeit | 💡 Idee |
...
| [docs/solita/solita-stufe2-aktivierung.md](docs/solita/solita-stufe2-aktivierung.md) | „Actionable" Stufe 2 — Tool-Use-Aktivierung | 📚 Referenz |
| [docs/solita/solita-vosk-hybrid.md](docs/solita/solita-vosk-hybrid.md) | Always-on Vosk-Hybrid (Weckwort nativ) | 📚 Referenz |
| [docs/solita/solita-vosk-wakeword.md](docs/solita/solita-vosk-wakeword.md) | Vosk-Weckwort „Solita" — Grammar-Trick, Selbsthör-Blocker | 📚 Referenz |
...
| [krass-app/wakeword-solita-erkennung.md](krass-app/wakeword-solita-erkennung.md) | Weckwort zuverlässig erkennen — Vosk-Wortliste vs. eigene Stimme | 💡 Idee |
...
| Notiz | Worum es geht | Status |
|---|---|---|
| [backlog.md](backlog.md) | Offene Wünsche quer übers Projekt (Karten-PIN, PlantNet <20 %, Route Ulfladen …); markiert Gebautes | 🎒 Backlog |
...
> Der Auslöser-Brief liegt archiviert: [notes/global-check-forloop-2026-06-07.md](notes/global-check-forloop-2026-06-07.md).
...
| Notiz | Worum es geht |
|---|---|
| [notes/notiz-2026-06-16.md](notes/notiz-2026-06-16.md) | Navigation: Punkt mitführen, sofort Fadenkreuz, Zieleingabe überarbeiten |
...
| [notes/notiz-2026-06-13.md](notes/notiz-2026-06-13.md) | Tagesnotiz 13.06. |
| [notes/fahrt-bad-homburg-2026-06-10.md](notes/fahrt-bad-homburg-2026-06-10.md) | Fahrt-Notizen Bad Homburg 10.06. |
| [notes/stand-branch-cleanup-2026-06-16.md](notes/stand-branch-cleanup-2026-06-16.md) | Stand: Branch-Cleanup (9 Branches gelöscht, Notizen gesichert) |
| [notes/global-check-forloop-2026-06-07.md](notes/global-check-forloop-2026-06-07.md) | Der Brief/Auftrag zum globalen Check (führte zu AUDIT) |
