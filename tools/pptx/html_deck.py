...
/* the header sits on its own white strip with a soft shadow, so answers scroll away UNDER it
...
#ask-head{font-family:Orbitron,sans-serif;font-size:10px;letter-spacing:1.6px;text-transform:uppercase;
  ...
  position:relative;z-index:1;margin:-12px -12px 0;padding:11px 12px 9px;background:#fff;
