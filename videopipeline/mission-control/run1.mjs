// Die ganze Klasse im Blick (Mission Control) — step 1: Solita speaks the script.
...
console.log('Mit Luft, Denkpause und Abspann landet der Film bei etwa', (total + 12 * 1.6 + 8).toFixed(0), 's.');
